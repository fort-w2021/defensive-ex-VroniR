...
Notes:
a)
- not logical, character, missings
- should be numeric
- not negative
- not infinite

b) Notiz für mich:
checkmate::assert_number() statt checkmate::assert_count() !!
die Zahl die rein geht muss nicht zwingend schon ein count sein, sie soll zu einem count werden, eine Nummer ist also auch ok.
